  ...
  {(popupState) => (
    <React.Fragment>
      ...
      <Menu {...bindMenu(popupState)}>
        ...
        <MenuItem onClick={popupState.close}><Link to='/authentication/sign-up/ngo'>Organisation</Link></MenuItem>
        {
        getCookie('username') &&
        <MenuItem onClick={ e=>{
          popupState.close
  ...
  {(popupState) => (
    <React.Fragment>
      ...
      <Menu {...bindMenu(popupState)}>
        ...
        <MenuItem onClick={popupState.close}><Link to='/sign-in/ngo'>Organisation login</Link></MenuItem>
       {
        getCookie('username') &&
        <MenuItem onClick={ e=>{
          popupState.close
